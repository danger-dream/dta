...
import { Language, localUrl } from './helper'
...
async function tencent(config: ITranslate, str: string): Promise<string> {
	try {
...
async function google(config: ITranslate, str: string): Promise<string> {
	try {
...
export default async function (config: ITranslate, str: string): Promise<string> {
	let lang = ''
	try {
